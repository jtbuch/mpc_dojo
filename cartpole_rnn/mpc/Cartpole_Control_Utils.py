...
def plot_pole_angle_heatmaps(results_folder="../results/PerformanceResults/", 
    ...
    fig, axes = plt.subplots(1, len(plot_ratios), figsize=(4*len(plot_ratios)+4, 5))
...
def plot_wind_mu_heatmaps(results_folder="../results/PerformanceResults/", 
    ...
    fig, axes = plt.subplots(1, len(plot_wind_mus), figsize=(4*len(plot_wind_mus)+4, 5))
...
def plot_wind_sigma_heatmaps(results_folder="../results/PerformanceResults/", 
    ...
    fig, axes = plt.subplots(1, len(plot_wind_sigmas), figsize=(4*len(plot_wind_sigmas)+4, 5))
...
def plot_init_angle_heatmaps(results_folder="../results/PerformanceResults/", 
    ...
    fig, axes = plt.subplots(1, len(plot_init_angles), figsize=(4*len(plot_init_angles)+4, 5))
